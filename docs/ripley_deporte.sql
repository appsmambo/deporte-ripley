...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-04-2015 a las 01:40:59
...
INSERT INTO `registro` (`id`, `dni`, `nombres`, `apellidos`, `telefono`, `email`, `distrito`, `codigo`, `newsletter`, `created_at`, `updated_at`, `estado`) VALUES
(1, '41369852', 'Carlos', 'Quintanilla', '123456789', 'quintanilla.peru@gmail.com', 'Lima', 5468795468790, NULL, '2015-04-10 01:57:46', '2015-04-10 01:57:46', 1),
(2, '54687912', 'carlos', 'quintanilla', '546879', 'q@q.cm', 'Lima', 5468795462132, NULL, '2015-04-10 03:13:49', '2015-04-10 03:13:49', 1),
(4, '54621355', 'juan', 'carlos', '546546', 'q@q.com', 'lima', 8795468795460, NULL, '2015-04-10 03:29:00', '2015-04-10 03:29:00', 1),
(5, '20965874', 'juan', 'carlos', '5454', 'aa@qq.com', 'lima', 7845457878458, NULL, '2015-04-10 03:56:41', '2015-04-10 03:56:41', 1),
(6, '41258741', 'alex', 'alexin', '897654564', 'administrador@amas.org', 'Lima Cercado', 5252525252525, NULL, '2015-04-10 04:32:55', '2015-04-10 04:32:55', 1);
...
ALTER TABLE `registro`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `dni` (`dni`,`codigo`), ADD UNIQUE KEY `email` (`email`);
